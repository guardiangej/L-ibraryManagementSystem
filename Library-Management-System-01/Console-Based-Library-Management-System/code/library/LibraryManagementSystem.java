...
public class LibraryManagementSystem {
    ...
    private static void borrowBook(Scanner scanner, BookManager bookManager, User user) {
        System.out.print("Enter the title of the book you want to borrow: ");
        String title = scanner.nextLine();
        
        if (bookManager.borrowBook(title)) {
    ...
    private static void returnBook(Scanner scanner, BookManager bookManager, User user) {
        System.out.print("Enter the title of the book you want to return: ");
        String title = scanner.nextLine();
        
        if (bookManager.returnBook(title)) {
